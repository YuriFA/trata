...
var (
	...
	ErrTransactionAccountNotFound = errors.New(
		"transaction references an account that does not exist",
	)
	ErrTransactionCategoryNotFound = errors.New(
		"transaction references a category that does not exist",
	)
	ErrTransactionFromAccountNotFound = errors.New(
		"transaction references a from-account that does not exist",
	)
	ErrTransactionToAccountNotFound = errors.New(
		"transaction references a to-account that does not exist",
	)
	...
	ErrDebtOperationDebtorNotFound  = errors.New(
		"debt operation references a debtor that does not exist",
	)
	ErrDebtOperationImmutable = errors.New(
		"debt operation debtor, direction, and kind are immutable",
	)
	...
	ErrPlannedPaymentAccountNotFound = errors.New(
		"planned payment references an account that does not exist",
	)
	ErrPlannedPaymentCategoryNotFound = errors.New(
		"planned payment references a category that does not exist",
	)
	ErrPlannedPaymentCategoryTypeMismatch = errors.New(
		"planned payment category type does not match the plan type",
	)
	ErrCategoryArchived = errors.New(
	...
	ErrPushSubscriptionTimezoneInvalid = errors.New(
		"push subscription timezone is not a known IANA zone",
	)
	ErrAccountHasPlannedPayments = errors.New(
		"account has planned payments and cannot be deleted",
	)
	ErrCategoryHasPlannedPayments = errors.New(
	...
	ErrHouseholdOwnerWithMembers = errors.New(
		"the owner cannot leave a household with other members",
	)
	ErrHouseholdMemberNotFound = errors.New("household member not found")
	ErrHouseholdMemberIsOwner  = errors.New(
		"the owner cannot be removed from the household",
	)
	ErrHouseholdDissolveConfirmRequired = errors.New(
		"household dissolution requires an explicit confirm",
	)
